...
int main()
{
	...
	for (int i=1;i<=R_max;i++)
		route[i] = new stop;
	initialsolution(count,route,n,mylist,num_of_terminal,num_of_destination,terminal_list,destination_list,R_max,T_max,S_max,shortest_time_matrix);
	...
	cout << endl << endl;
	updateinitialsolution(route,n,mylist,num_of_terminal,num_of_destination,terminal_list,destination_list,R_max,T_max,S_max,shortest_time_matrix);
